...
menu() {
    update_sh
    echo -e "\t Skrip manajemen instalasi V2ray ${Red}[${shell_version}]${Font}"
    echo -e "\t---authored by Kemaddd---"
    echo -e "Versi yang terinstal saat ini:${shell_mode}\n"
    ...
    echo -e "${Green}4.${Font}  Ganti UUID"
    echo -e "${Green}5.${Font}  Ganti alterid"
    echo -e "${Green}6.${Font}  Ganti port"
    echo -e "${Green}7.${Font}  Ganti versi TLS"
    echo -e "———————————— Lihat informasi ————————————"
    echo -e "${Green}8.${Font}  Lihat log akses"
    echo -e "${Green}9.${Font}  Lihat log error"
    echo -e "${Green}10.${Font} Lihat informasi konfigurasi V2Ray"
    echo -e "—————————————— 其他选项 ——————————————"
    echo -e "${Green}11.${Font} Instal skrip instalasi kecepatan tajam 4 in 1 bbr"
    echo -e "${Green}12.${Font} Instal MTproxy (mendukung obfuscation TLS)"
    echo -e "${Green}13.${Font} Pembaruan Validitas Sertifikat"
    echo -e "${Green}14.${Font} uninstall V2Ray"
    echo -e "${Green}15.${Font} Perbarui tugas terjadwal crontab sertifikat"
    echo -e "${Green}16.${Font} File warisan sertifikat"
